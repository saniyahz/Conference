    ...
    <div className="min-h-screen p-4 md:p-8 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <Link href="/" className="flex items-center gap-2 mb-2">
                ...
                <h1 className="text-3xl font-bold text-amber-800">My Story Library</h1>
              </Link>
            ...
            <div className="flex gap-3">
              <Link
                href="/pricing"
                className="px-4 py-2 border-2 border-amber-600 text-amber-600 rounded-lg hover:bg-amber-50 font-semibold flex items-center gap-2"
              >
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {/* Current Plan */}
          <div className="bg-gradient-to-br from-amber-600 to-orange-600 text-white rounded-2xl shadow-xl p-6">
            ...
            {planType === 'free' && (
              <Link
                href="/pricing"
                className="mt-4 block w-full text-center bg-white text-amber-600 py-2 rounded-lg font-semibold hover:bg-gray-100"
              >
        ...
        <div className="flex gap-4 mb-8">
          <Link
            href="/"
            className="flex-1 bg-amber-600 text-white p-6 rounded-2xl shadow-xl hover:bg-amber-700 transition-all flex items-center justify-center gap-3"
          >
        ...
        {/* Saved Stories */}
        <div className="bg-white rounded-2xl shadow-xl p-6 border-2 border-amber-100">
          <h2 className="text-2xl font-bold text-amber-800 mb-6">My Saved Stories</h2>
          ...
          {stories.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Link
                href="/"
                className="inline-block px-6 py-3 bg-amber-600 text-white rounded-lg hover:bg-amber-700 font-semibold"
              >
              ...
              {stories.map((story) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 className="text-xl font-bold text-amber-800 mb-1">{story.title}</h3>
                      {story.author && (
