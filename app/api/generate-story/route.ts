...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📖 Generating unique 12-page story with OpenAI from:', prompt)

    // Use OpenAI GPT-4 to generate a unique, kid-friendly 12-page story
    const completion = await openai.chat.completions.create({
      model: 'gpt-4',
      messages: [
        {
          role: 'system',
          content: `You are a creative children's story writer. Create engaging, unique 12-page stories for kids aged 4-8 based on their ideas.

IMPORTANT RULES:
- Create a UNIQUE story based on what the child says - don't use generic templates
- The story should be EXACTLY 12 pages long
...
[2-3 sentences - happy ending]`
        ...
        {
          role: 'user',
          content: `A child wants a story about: "${prompt}". Create a unique, magical 12-page story based on their idea!`
        }
      ],
      temperature: 0.9,
      max_tokens: 2000,
    ...
    console.log('✅ 12-page story generated by OpenAI GPT-4')
