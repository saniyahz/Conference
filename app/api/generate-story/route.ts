...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📖 Generating unique 4-page story with Replicate Llama from:', prompt)

    // Use Replicate Llama 3.3 70B (FREE!) to generate story
    const systemPrompt = `You are a creative children's story writer. Create engaging, unique 4-page stories for kids aged 4-8 based on their ideas (like Google Gemini Storybook format).
...
[4-6 sentences - problem solved, celebration, what they learned, happy ending]`
    ...
    console.log('✅ 4-page story generated by Replicate Llama (FREE!)')
