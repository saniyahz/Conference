    ...
    <main className="min-h-screen bg-gradient-to-b from-teal-50 via-yellow-50 to-orange-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-8 border-2 border-teal-200">
          ...
          {/* Our Mission */}
          <div className="bg-gradient-to-r from-teal-50 to-green-50 rounded-2xl p-6 md:p-8 mb-8 border-2 border-teal-100">
            <div className="flex items-center gap-3 mb-4">
              <Heart className="w-8 h-8 text-red-500" />
              <h2 className="text-2xl font-bold text-teal-700">Our Mission</h2>
            </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-teal-700">Why We Started This Journey</h2>
            </div>
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <p className="text-lg leading-relaxed">
                ...
                <em className="text-teal-600 font-semibold"> "I'm an author! I created this!"</em>
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-teal-50 rounded-xl p-6 border-2 border-teal-200 text-center">
              ...
              <h3 className="text-lg font-bold text-teal-700 mb-2">Every Voice Matters</h3>
            ...
            <div className="bg-yellow-50 rounded-xl p-6 border-2 border-yellow-200 text-center">
              ...
              <h3 className="text-lg font-bold text-yellow-700 mb-2">Creativity Builds Confidence</h3>
            ...
            <div className="bg-orange-50 rounded-xl p-6 border-2 border-orange-200 text-center">
              ...
              <h3 className="text-lg font-bold text-orange-700 mb-2">Reading is an Adventure</h3>
          ...
          <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-6 md:p-8 mb-8 border-2 border-green-200">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-green-700">The Journey Into Reading</h2>
            </div>
          ...
          <div className="bg-teal-100 rounded-2xl p-6 md:p-8 border-2 border-teal-300 text-center">
            ...
            <h2 className="text-2xl font-bold text-teal-700 mb-4">Benny's Promise</h2>
            ...
            <p className="text-teal-600 mt-4 font-semibold">— Benny the Story Beaver</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-8 py-4 bg-teal-500 text-white rounded-full hover:bg-teal-600 font-bold text-lg transition-all transform hover:scale-105 shadow-lg"
          >
