...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-8 border-2 border-amber-200">
          ...
          {/* Our Mission */}
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 md:p-8 mb-8 border-2 border-amber-100">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-amber-800">Why We Started This Journey</h2>
            </div>
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <p className="text-lg leading-relaxed">
                ...
                <em className="text-amber-700 font-semibold"> "I'm an author! I created this!"</em>
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-200 text-center">
              ...
              <h3 className="text-lg font-bold text-blue-800 mb-2">Every Voice Matters</h3>
            ...
            <div className="bg-green-50 rounded-xl p-6 border-2 border-green-200 text-center">
              ...
              <h3 className="text-lg font-bold text-green-800 mb-2">Creativity Builds Confidence</h3>
            ...
            <div className="bg-purple-50 rounded-xl p-6 border-2 border-purple-200 text-center">
              ...
              <h3 className="text-lg font-bold text-purple-800 mb-2">Reading is an Adventure</h3>
          ...
          <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-6 md:p-8 mb-8 border-2 border-green-200">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-green-800">The Journey Into Reading</h2>
            </div>
          ...
          {/* Benny's Promise */}
          <div className="bg-amber-100 rounded-2xl p-6 md:p-8 border-2 border-amber-300 text-center">
            <div className="text-5xl mb-4">🦫</div>
            <h2 className="text-2xl font-bold text-amber-800 mb-4">Benny's Promise</h2>
            ...
            <p className="text-amber-700 mt-4 font-semibold">— Benny the Story Beaver</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-8 py-4 bg-amber-600 text-white rounded-full hover:bg-amber-700 font-bold text-lg transition-all transform hover:scale-105 shadow-lg"
          >
        ...
        {/* Footer */}
        <div className="mt-12 text-center text-amber-600 text-sm">
          <p>Made with love for young storytellers everywhere</p>
          <div className="flex justify-center gap-4 mt-4">
            <Link href="/pricing" className="hover:text-amber-800 underline">Pricing</Link>
            <Link href="/" className="hover:text-amber-800 underline">Create a Story</Link>
          </div>
        </div>
      </div>
    </main>
